...
export const GITHUB_CONFIG = {
  changelogUrl: "https://raw.githubusercontent.com/SyferX/SyferX/refs/heads/main/CHANGELOG.md",
  donateUrl: "",
};

// Updater configuration
export const UPDATER_CONFIG = {
  npmPackageName: "syferx",
  installCmd: "npm i -g syferx",
  installCmdLatest: "npm i -g syferx@latest --prefer-online",
