...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-bg p-4 relative overflow-hidden">
      ...
      {/* Accent glow */}
      <div className="absolute top-1/4 left-1/2 -translate-x-1/2 w-[520px] h-[420px] rounded-full blur-[120px] pointer-events-none" style={{ backgroundColor: "color-mix(in srgb, var(--color-primary) 14%, transparent)" }} aria-hidden="true" />
      <div className="relative z-10 w-full max-w-md">
        <div className="text-center mb-8">
          <div className="flex justify-center mb-4">
            <div className="flex items-center justify-center size-16 rounded-2xl bg-gradient-to-br from-brand-400 to-brand-600 shadow-[var(--shadow-warm)]">
          ...
          <h1 className="text-3xl font-bold mb-2 tracking-tight">Syfer<span className="text-primary">X</span></h1>
                ...
                <div className="flex flex-col gap-2">
                  ...
                  {resetHint && (
                    <p className="text-xs text-text-muted">
                      Forgot password? Open <code className="bg-sidebar px-1 rounded">syferx</code> CLI on the host → <b>Settings</b> → <b>Reset Password to Default</b>.
                    </p>
                  )}
                </div>
