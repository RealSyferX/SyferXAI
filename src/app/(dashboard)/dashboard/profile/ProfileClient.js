          ...
          <div className="flex flex-col gap-3 pt-4 border-t border-border">
            <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
              <div>
                ...
                <p className="text-xs text-text-muted">Personalize the primary/brand color across the app</p>
              </div>
              <div className="flex flex-wrap items-center gap-2">
                {[
                  ...
                  <button
                    ...
                    className={cn(
                      ...
                      (accentColor || "").toLowerCase() === c.hex ? "border-text-main scale-110" : "border-transparent"
                    )}
                    style={{ backgroundColor: c.hex }}
                    aria-label={`Set accent color to ${c.name}`}
                  />
                ))}
                <label className="relative size-7 rounded-full overflow-hidden border-2 border-border cursor-pointer hover:scale-110 transition-transform flex items-center justify-center bg-surface-2" title="Custom color">
                  <span className="material-symbols-outlined text-[16px] text-text-muted">colorize</span>
                  <input
                    type="color"
                ...
                {accentColor && (
                  <button
                    ...
                    className="text-xs text-text-muted hover:text-primary underline underline-offset-2"
                  >
                    Reset
                  </button>
                )}
