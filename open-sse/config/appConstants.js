...
// Kimi/Kimchi client version (used for User-Agent + X-Msh-Version headers)
export const KIMCHI_VERSION = "2.1.2";

// Synchronous accessor for the Kimchi client version
export function getKimchiVersionSync() {
  return KIMCHI_VERSION;
}
